...
exports.default = new VoiceEventHandler_1.VoiceEventHandler({
    name: aoi_music_1.PlayerEvents.AudioError,
    description: "Emitted and executed when audio throws an error.",
    listener(error, player) {
        const commands = this.getExtension(ErisaVoice_1.ErisaVoice, true).commands.get(aoi_music_1.PlayerEvents.AudioError);
        if (!commands)
            return;
