...
exports.default = new VoiceEventHandler_1.VoiceEventHandler({
    name: aoi_music_1.PlayerEvents.TrackAdd,
    description: "Emitted and executed when a track is added into the music player.",
    listener(track, player) {
        const commands = this.getExtension(ErisaVoice_1.ErisaVoice, true).commands.get(aoi_music_1.PlayerEvents.TrackAdd);
        if (!commands)
            return;
