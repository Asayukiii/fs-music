...
exports.default = new VoiceEventHandler_1.VoiceEventHandler({
    name: aoi_music_1.PlayerEvents.TrackStart,
    description: "Emitted and executed when a track starts playing.",
    listener(track, player) {
        const commands = this.getExtension(ErisaVoice_1.ErisaVoice, true).commands.get(aoi_music_1.PlayerEvents.TrackStart);
        if (!commands)
            return;
