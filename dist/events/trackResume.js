...
exports.default = new VoiceEventHandler_1.VoiceEventHandler({
    name: aoi_music_1.PlayerEvents.TrackResume,
    description: "Emitted and executed when a track is resumed.",
    listener(player) {
        const commands = this.getExtension(ErisaVoice_1.ErisaVoice, true).commands.get(aoi_music_1.PlayerEvents.TrackResume);
        if (!commands)
            return;
